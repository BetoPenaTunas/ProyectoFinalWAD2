...
import util.DatosGraficaDAO;
import util.DatosGraficaDTO;
...
public class VentasSources extends HttpServlet {
    ...
    private void verReportePDF(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            reporte = new File(getServletConfig().getServletContext().getRealPath("/reportes/reporteVentas.jasper")); //Se indica la ruta del REPORTE dentro del proyecto
        ...
        if(datos!=null){
            ...
            for (DatosGraficaDTO dato : datos) {
                ...
                switch(datos[i].getTipo()){
                    case "EMP":
                        datos[i].setTipo("ALIMENTOS EMPAQUETADOS");
                        break;
                    
                    case "PRP": 
                        datos[i].setTipo("SUMPLEMENTOS ");
                        break;
    ...
    private void verGrafica(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            String archivoAux=getServletConfig().getServletContext().getRealPath("/grafica.png");
            System.out.println("Pruebas: "+archivoAux);
