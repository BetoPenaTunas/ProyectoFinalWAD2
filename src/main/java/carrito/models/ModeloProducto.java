...
//            String sql = "call selectalimentos()";
    ...
    public ArrayList<Producto> getBebidas(){
        ...
        ResultSet rs = null;
        try {
            String sql ="select * from alimentos where id like '%BBD%';";
            pst = cn.getConnection().prepareCall(sql);
            rs = pst.executeQuery();
            while(rs.next()){
                productos.add(new Producto(rs.getString("id"),rs.getString("alimento"
    ...
    public ArrayList<Producto> getSumplementos(){
        ArrayList<Producto> productos = new ArrayList<>();
        PreparedStatement pst = null;
        ResultSet rs = null;
        try {
            String sql ="select * from alimentos where id like '%PRP%';";
            pst = cn.getConnection().prepareCall(sql);
            rs = pst.executeQuery();
            while(rs.next()){
                productos.add(new Producto(rs.getString("id"),rs.getString("alimento"
    ...
    public ArrayList<Producto> getEmpaquetados(){
        ArrayList<Producto> productos = new ArrayList<>();
        PreparedStatement pst = null;
        ResultSet rs = null;
        try {
            String sql ="select * from alimentos where id like '%EMP%';";
            pst = cn.getConnection().prepareCall(sql);
            rs = pst.executeQuery();
            while(rs.next()){
                productos.add(new Producto(rs.getString("id"),rs.getString("alimento"
